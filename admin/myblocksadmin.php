...
// ------------------------------------------------------------------------- //
// Modified for WF-Section = Liquid
...
function list_blocks()
{
    ...
    foreach( array_keys( $block_arr ) as $i )
    {
        ...
        {
            $sseln = " checked='checked' style='background-color:#c2cdd6;'";
        } 
    ...
    function list_groups()
    {
        ...
        $form = new MyXoopsGroupPermForm( "<h3 style='text-align:left; color: #2F5376; '>" . _MD_AM_ADGS . "</h3>\n" , 1 , 'block_read' , '' ) ;
    ...
    mag_admin_menu( _AM_MAG_BLOCKSHEADING );
    mag_textinfo( _AM_MAG_BLOCKSINFO, _AM_MAG_BLOCKSTEXT );

    echo "<h3 style='text-align:left; color: #2F5376; '>" . $xoopsModule->name() . ": " . _AM_BADMIN . "</h3>\n" ;
    list_blocks() ;
    list_groups() ;
    xoops_cp_footer() ;
