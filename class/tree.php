<?php
// $Id: tree.php,v 1.6 2005/02/07 01:25:26 phppp Exp $
//  ------------------------------------------------------------------------ //
...
class MagTree extends XoopsTree
{
    ...
    function MagTree($table_name, $id_name, $pid_name, $status = 1, $published = 0)
    {
    ...
    function makeMyRootedSelBox($title, $order = "", $root = 0, $recurse = false, $preset_id = 0, $showroot = 0, $sel_name = "", $onchange = "", $size = 1, $multipule = "")
    {
        ...
        else
        {
            ...
            {
                $rootaccess = Mag_checkAccess($rootaccess);
            }
            else
            {
                $rootaccess = 0;
                ...
                if (Mag_checkAccess($groupid))
                {
                    ...
                    if ($recurse)
                    {
                        ...
                        foreach ($arr as $option)
                        {
                			...
                			if (!Mag_checkAccess($option['groupid'])) continue;
